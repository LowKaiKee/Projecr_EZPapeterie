...
<html>
	...
	<body>
		...
		<div class="main">
			<div class="container">
				<form name="forgetForm" action="/ezpapeterie/php/admin/forget.php" onsubmit="return validateForgetForm()" method="post">
					<!-- EMAIL -->
					<div class="row">
						<div class="col-25">
		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				<?php
					...
					header("refresh:1; url=/ezpapeterie/php/admin/loginad.php");
				?>
				<?php
					}else{
					echo 'no result';
